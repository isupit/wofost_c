...
{     
    ...
    Crop->N_rt.Uptake = fmax(0.,fmin(Total_N_demand - N_Fix_rt, (Site->st_N_tot + Site->rt_N_mins))) * NutrientLimit;
    Crop->P_rt.Uptake = fmax(0.,fmin(Total_P_demand, (Site->st_P_tot + Site->rt_P_mins)))* NutrientLimit;
    Crop->K_rt.Uptake = fmax(0.,fmin(Total_K_demand, (Site->st_K_tot + Site->rt_K_mins)))* NutrientLimit;
